<script>
	...
	import Kid from "$components/MiddleSchool_VIDEO/MiddleSchool.Kid.svelte";
	let isWebKit = false;
	...
	let containerWidth = 1920/3;
	let containerHeight = 1080 - 150;
	let zoomed = "";
...
<div class="eyes {zoomed}" style={zoomStyle}>
	{#key w}
	{#each data as d}
